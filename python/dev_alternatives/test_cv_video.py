...
if __name__ == "__main__":
    ...
    hist_3d_s[0] = savitzky_golay(hist_3d_m[0], 41, 3) # window size 51, polynomial order 3
    hist_3d_s[1] = savitzky_golay(hist_3d_m[1], 41, 3) # window size 51, polynomial order 3
    hist_3d_s[2] = savitzky_golay(hist_3d_m[2], 41, 3) # window size 51, polynomial order 3
    if args.verbose:
